    ...
    def __init__(self):
        ...
        self._translations: Dict[str, Dict[str, str]] = {
            "en": {
                ...
                "MultiScreenKiosk was updated to version {version}. Please restart the application to finish.": "MultiScreenKiosk was updated to version {version}. Please restart the application to finish.",
                "Update failed": "Update failed",
                "Automatic update failed: {error}": "Automatic update failed: {error}",
            ...
            "de": {
                ...
                "MultiScreenKiosk was updated to version {version}. Please restart the application to finish.": "MultiScreenKiosk wurde auf Version {version} aktualisiert. Bitte die Anwendung neu starten, um abzuschließen.",
                "Update failed": "Update fehlgeschlagen",
                "Automatic update failed: {error}": "Automatisches Update fehlgeschlagen: {error}",
                "Placeholder GIF": "Placeholder-GIF",
                "Logo": "Logo",
                "Loading...": "Lade...",
                "Level": "Level",
